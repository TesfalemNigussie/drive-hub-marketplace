...
import { Car, MapPin, Bell, ShoppingCart, FileText, Wrench, Home } from "lucide-react";
        ...
        return (
          <div className="space-y-8">
            ...
            <section className="text-center space-y-4 py-8">
              <div className="inline-flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-full border border-blue-200">
                <Car className="w-4 h-4 text-blue-600" />
                <span className="text-sm font-medium text-blue-600">Complete Vehicle Management</span>
              </div>
              <h1 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 bg-clip-text text-transparent leading-tight">
                Your Complete
                <br />
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center pt-3">
                ...
                <Button 
                  variant="outline" 
                  size="lg"
                  className="border-2 border-slate-300 hover:border-blue-400 px-6 py-2 rounded-xl hover:bg-blue-50 transition-all duration-300"
              ...
              {features.map((feature, index) => (
                <Card key={index} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-lg">
                  <CardHeader className="pb-2">
                    <div className={`w-10 h-10 rounded-xl bg-gradient-to-r ${feature.color} p-2 mb-2 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
          <div className="flex justify-between items-center h-14">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-slate-900">VehiclePro</span>
            </div>
